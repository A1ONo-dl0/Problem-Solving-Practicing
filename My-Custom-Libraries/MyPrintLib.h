...
namespace MyPrintLib
{
	...
	void PrintFibonacciSeriesUsingRecursion(short NumOfSeries, short FibNum, short Prev1, short Prev2)
	{
		if (NumOfSeries > 0)
		{
			cout << FibNum << "   ";
			...
			Prev1 = Prev2;
			Prev2 = FibNum;
			PrintFibonacciSeriesUsingRecursion(NumOfSeries - 1, FibNum, Prev1, Prev2);
		}
	}
